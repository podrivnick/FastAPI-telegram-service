...
class BaseWebArtsServiceException(BaseApplicationException):
    status_code: int
...
@dataclass(frozen=True, eq=False)
class ArtNotReceivedException(BaseWebArtsServiceException):
    @property
    def message(self):
        return "No art received from the API"
